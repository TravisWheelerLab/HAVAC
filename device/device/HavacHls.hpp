...
#define PHMM_STREAM_DEPTH 64        // 1 ultraram is 288Kb, or 9,000 phmm vectors
#define HIT_REPORT_STREAM_DEPTH 8
#define NUM_HITS_STREAM_DEPTH 2
#define ULTRARAM_BYTES_PER_RAM 36000ULL  // 1 bram is 288Kb, or 36000 bytes.
#define SCORE_QUEUE_SIZE (620LL* ULTRARAM_BYTES_PER_RAM) // 1 ultraram is 288Kb, or  36,000 bytes.
...
void HavacKernelTopLevel(SequenceSegmentWord* sequenceSegmentMemory, uint32_t sequenceLengthInSegments,
  uint32_t* phmmMemory, uint32_t phmmLengthInVectors, struct HitReport* hitReportMemory, uint32_t& numHits);
