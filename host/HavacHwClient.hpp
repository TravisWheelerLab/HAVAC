...
public:
  ...
  ///         Note, these are hits represented as uint64_t data, which must be decoded and referenced
  ///         against the FastaVector and PhmmList to determine actual placement
  vector<uint64_t> getHitList();
...
protected:
  ...
  static const uint64_t hitReportAllocationSizeInBytes =  14*256UL * 1024UL * 1024UL;     //3.5GiB
